...
public class Estancias {
    ...
    a) Se tienen contactos con familias de diferentes países que ofrecen alguna de las 
    ...
    b) Cada una de estas familias vive en una casa, de la que se conoce la dirección (calle, 
    ...
    c) Se dispone también de información de los clientes que desean mandar a sus hijos a 
    alguna de estas familias: nombre, dirección (calle, numero, código postal, ciudad y 
    país) y su correo electrónico.
    d) En la BD se almacena información de las reservas y estancias realizadas por alguno 
    ...
    e) El sistema debe también almacenar información brindada por los clientes sobre las 
    ...
    “estancias_exterior.sql” lo van a encontrar en el archivo persistencia.zip.
